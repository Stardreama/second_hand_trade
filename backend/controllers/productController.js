...
const createProduct = (req, res) => {
    ...
    if (!price || !description || !seller_id || !title || !product_status || !product_class) {
    ...
    // 插入产品记录（只保存封面图片）
    Product.create(seller_id, price, description, coverImage, title, product_status, product_class, (err, result) => {
        if (err) {
...
module.exports = { createProduct, searchProduct, addImage };
