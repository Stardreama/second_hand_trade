  ...
  <view v-if="productDetail" class="page-wrapper" :class="{ 'off-shelf-container': productDetail.is_off_shelf === 1 }">
    ...
    <view class="bg-white">
      <view class="cf padding-sm">
        <view class="radius fl padding-sm" @tap="navigateToUserInfo(productDetail.seller_id)">
        ...
        <view v-if="showFollowButton" class="follow-btn-container">
          <view class="follow-btn" :class="{ 'follow-btn-active': isFollowing, 'bounce-animation': buttonBouncing }"
            @click="toggleFollow">
    ...
    <view class="action-bar-container">
      <view class="action-bar-wrapper bg-white">
        ...
        <view class="action-left">
          ...
          ">
            <uni-icons type="chat" color="#007aff" size="34"></uni-icons>
...
export default {
  ...
  methods: {
    ...
    navigateToUserInfo(userId) {
      ...
      const params = {
        id: userId,
        username: encodeURIComponent(this.productDetail.seller_name || ''),
        avatar: encodeURIComponent(this.getImageUrl(this.productDetail.seller_avatar) || '')
      };

      // 构建URL字符串
      const url = `/pages/my/user_info/user_info?id=${params.id}&username=${params.username}&avatar=${params.avatar}`;
...
@keyframes flyItem1 {
  ...
  60% {
    transform: translateY(-500rpx) translateX(70rpx) rotate(20deg) scale(1.2);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-800rpx) translateX(100rpx) rotate(45deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem2 {
  ...
  60% {
    transform: translateY(-450rpx) translateX(40rpx) rotate(-15deg) scale(1.3);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-750rpx) translateX(60rpx) rotate(-30deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem3 {
  ...
  60% {
    transform: translateY(-550rpx) translateX(20rpx) rotate(30deg) scale(1.1);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-850rpx) translateX(30rpx) rotate(60deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem4 {
  ...
  60% {
    transform: translateY(-600rpx) translateX(0rpx) rotate(-20deg) scale(1.4);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-900rpx) translateX(0rpx) rotate(-40deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem5 {
  ...
  60% {
    transform: translateY(-550rpx) translateX(-20rpx) rotate(10deg) scale(1.2);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-850rpx) translateX(-30rpx) rotate(20deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem6 {
  ...
  60% {
    transform: translateY(-450rpx) translateX(-40rpx) rotate(-25deg) scale(1.3);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-750rpx) translateX(-60rpx) rotate(-50deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem7 {
  ...
  60% {
    transform: translateY(-500rpx) translateX(-70rpx) rotate(15deg) scale(1.1);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-800rpx) translateX(-100rpx) rotate(30deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem8 {
  ...
  60% {
    transform: translateY(-520rpx) translateX(100rpx) rotate(30deg) scale(1.4);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-820rpx) translateX(150rpx) rotate(60deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem10 {
  ...
  60% {
    transform: translateY(-480rpx) translateX(130rpx) rotate(45deg) scale(1.3);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-950rpx) translateX(180rpx) rotate(90deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem12 {
  ...
  65% {
    transform: translateY(-580rpx) translateX(50rpx) rotate(60deg) scale(1.2);
    opacity: 0.9;
  }

  100% {
    transform: translateY(-880rpx) translateX(80rpx) rotate(120deg) scale(0);
    opacity: 0;
  }
}
...
@keyframes flyItem14 {
  ...
  70% {
    transform: translateY(-650rpx) translateX(30rpx) rotate(-10deg) scale(1.5);
    opacity: 0.85;
  }

  100% {
    transform: translateY(-1000rpx) translateX(60rpx) rotate(-20deg) scale(0);
    opacity: 0;
  }
}
...
.follow-center-heart {
  font-size: 240rpx;
  /* 增大尺寸 */
  text-shadow: 0 0 40rpx rgba(255, 71, 87, 0.9);
  /* 增强发光效果 */
}
