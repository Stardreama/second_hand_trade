  ...
  <view class="container">
    <view class="form-group">
      ...
      <view class="form-item">
        ...
        <input class="input" v-model="addressForm.name" placeholder="收货人姓名" />
      </view>

      <!-- 手机号码 -->
      <view class="form-item">
        <text class="label">手机号码</text>
        <input class="input" type="number" v-model="addressForm.phone" placeholder="请输入手机号" />
      </view>
      ...
      <view class="form-item">
        ...
        <view class="region-picker">
          <picker mode="region" fields="region" @change="regionChange"
      ...
      <view class="form-item">
        ...
        <textarea class="textarea" v-model="addressForm.address" placeholder="街道、楼牌号等" />
      </view>

      <!-- 设为默认地址 -->
      <view class="form-item switch-item">
        <text class="label">设为默认地址</text>
        <switch :checked="addressForm.isDefault" @change="switchChange" color="#0081ff" />
      </view>
    </view>
